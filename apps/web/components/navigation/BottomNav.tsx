...
import { Home, Map, Zap, BarChart3, Cat, LucideIcon } from 'lucide-react'
...
const TABS: Tab[] = [
  ...
  { id: 'pet', label: 'Kedi', icon: Cat, path: '/dashboard/pet' },
]
    ...
    >
      ...
      >
        {TABS.map((tab) => {
          ...
          return (
            <Link key={tab.id} href={tab.path} className="flex min-w-[48px] flex-col items-center">
              <motion.div
