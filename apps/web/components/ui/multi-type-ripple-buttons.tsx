    ...
    return (
      <>
        ...
        <button className={hoverButtonFinalClassName} onClick={handleButtonClick} disabled={disabled}>
          ...
          {jsRippleElements}
          <div
            className="hover-variant-grid-container pointer-events-none absolute inset-0 grid overflow-hidden z-[0]"
          ...
          >
            ...
            <div className="hover-variant-visual-ripple pointer-events-none absolute w-0 h-0 rounded-full -translate-x-1/2 -translate-y-1/2 transform top-0 left-0 z-[-1]" />
          </div>
        </button>
      </>
    )
    ...
    return (
      <>
        ...
        <button className={hoverBorderButtonFinalClassName} onClick={handleButtonClick} disabled={disabled}>
          ...
          {jsRippleElements}
          <div
            className="hoverborder-variant-ripple-container pointer-events-none absolute inset-0 grid overflow-hidden rounded-[0.8em] z-[0]"
            style={{ gridTemplateColumns: `repeat(${GRID_HOVER_NUM_COLS}, 0.25em)` }}
          >
            {Array.from({ length: GRID_HOVER_TOTAL_CELLS }, (_, index) => (
              <span
            ...
            <div className="hoverborder-variant-visual-ripple pointer-events-none absolute w-0 h-0 rounded-full -translate-x-1/2 -translate-y-1/2 transform top-0 left-0 z-[-1]" />
          </div>
        </button>
      </>
    )
