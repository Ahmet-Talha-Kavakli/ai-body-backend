...
export function ParticleCanvas({
  ...
  const webglRef = useRef<WebGLRefs>({
    shaderProgram: null,
    attribLocs: { position: 0, color: 0 },
    buffers: { position: null, color: null },
    uniformLocs: { resolution: null, tick: null },
  ...
  useEffect(() => {
    ...
    const vertexShader = Helper.createShader(gl, gl.VERTEX_SHADER, Helper.pixel2DVertexVaryingShader)
    const fragmentShader = Helper.createShader(gl, gl.FRAGMENT_SHADER, Helper.uniform2DFragmentVaryingShader)
    const shaderProgram = Helper.createProgram(gl, vertexShader, fragmentShader)
