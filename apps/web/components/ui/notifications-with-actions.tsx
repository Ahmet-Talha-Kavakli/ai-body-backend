...
export function NotificationsWithActions({
      ...
      <PopoverTrigger asChild>
        <button className="relative inline-flex items-center justify-center rounded-full p-2 hover:bg-muted">
          ...
          {notifications.length > 0 && (
            <Badge variant="default" className="absolute -top-1 -right-1 text-xs px-1.5 py-0">
                    ...
                    <div className="ml-2 flex items-center">
                      {isActive ? (
                        <div className="flex items-center space-x-2">
                          <button className="p-1 rounded-md hover:bg-muted" onClick={handleArchive}>
                          ...
                          <button className="p-1 rounded-md hover:bg-muted" onClick={() => setActiveId(null)}>
