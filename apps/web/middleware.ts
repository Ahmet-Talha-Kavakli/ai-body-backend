...
function applySecurityHeaders(response: NextResponse): NextResponse {
  ...
  // Content Security Policy - dev'de gevşek, prod'da sıkı
  if (!isDev) {
    const csp = [
      "default-src 'self'",
      ...
      `connect-src 'self' https://api.clerk.com https://*.clerk.accounts.dev https://clerk.com https://*.clerk.com https://vercel.live https://*.vercel.live https://clerk-telemetry.com https://*.vercel.dev wss:`,
