...
const CONTENT_SECTIONS: {
...
}[] = [
  {
    ...
    bg: '#E5F2FF',
    title: 'Genel Özet',
    desc: 'Toplam su tüketimi, ortalama günlük miktar ve hedef başarısı',
  },
  {
    key: 'drinks',
    icon: 'cafe',
    color: '#FF9500',
    bg: '#FFF4E5',
    title: 'İçecek Dağılımı',
    desc: 'Her içecek türünün tüketim yüzdesi ve miktarı',
  },
  {
    key: 'hydration',
    icon: 'stats-chart',
    color: '#5E5CE6',
    bg: '#EFEEFD',
    title: 'Hidrasyon Skoru',
    desc: 'Günlük hedefe ulaşma oranı ve devamlılık analizi',
  },
  {
    key: 'daily',
    icon: 'calendar',
    ...
    desc: 'Tarih bazlı tüketim listesi, hedef ve gerçekleşen',
  },
  {
    key: 'trend',
    icon: 'trending-up',
    ...
    desc: 'Haftalık/aylık su tüketimi artışı ve streak bilgisi',
  },
];
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
      ...
      <View style={s.hero}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={s.title}>Verilerini İndir</Text>
