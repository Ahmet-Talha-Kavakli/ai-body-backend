...
const CONTENT_SECTIONS: {
...
}[] = [
  {
    ...
    bg: '#FFF4E5',
    title: 'Öğün Geçmişi',
    desc: 'Kahvaltı, öğle, akşam ve atıştırmalıkların gün gün listesi, eklenen yiyecekler ve kalori detayları',
  },
  {
    key: 'macros',
    icon: 'pie-chart',
    color: '#EC4899',
    bg: '#FFE9F2',
    title: 'Makro Toplamları',
    desc: 'Günlük toplam ve ortalama kalori, protein, karbonhidrat, yağ değerleri',
  },
  {
    key: 'micros',
    icon: 'leaf',
    ...
    desc: 'Vitamin (A, C, D, E, K, B grubu) ve mineral (Ca, Fe, Mg, K, Zn) ortalamaları',
  },
  {
    key: 'goals',
    icon: 'flag',
    ...
    desc: 'Günlük kalori/makro hedefi ve hedefe ulaşma oranı',
  },
  {
    key: 'diet',
    icon: 'clipboard',
    ...
    desc: 'Mevcut diyet modu, planlanan vs uygulanan öğün karşılaştırması',
  },
  {
    key: 'water',
    icon: 'water',
    ...
    bg: '#E5F6FF',
    title: 'Sıvı Tüketimi',
    desc: 'Günlük su ve içecek alımı, ortalama tüketim',
  },
  {
    key: 'pantry',
    icon: 'basket',
    ...
    bg: '#FFF0E5',
    title: 'Mutfak (Pantry)',
    desc: 'Stoktaki malzemeler ve son kullanma tarihi yaklaşanlar',
  },
];
      ...
      <View style={{ flexDirection: 'row', marginBottom: 8 }}>
        {CAL_DAYS.map((d) => (
          <View key={d} style={{ flex: 1, alignItems: 'center' }}>
            <Text style={{ fontFamily: font.semibold, fontSize: 12, color: '#8E8E93' }}>{d}</Text>
          </View>
        ))}
      </View>
              ...
              <View key={col} style={{ flex: 1, alignItems: 'center' }}>
                {day !== null ? (
                  ...
                  >
                    <Text
                      style={{
                        fontFamily: sel ? font.extrabold : font.regular,
                        fontSize: 15,
        ...
        >
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 20 }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={{ fontFamily: font.regular, fontSize: 13, color: '#8E8E93', marginTop: 1 }}
              >
          ...
          {customStep === 'end' && (
            ...
            >
              ...
              <Text style={{ fontFamily: font.semibold, fontSize: 14, color: ACCENT }}>
                Başlangıca Dön
              </Text>
            </Pressable>
          )}
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
      ...
      <View style={s.hero}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={s.title}>Beslenme Verilerini İndir</Text>
...
export default function BeslenmeIndirRoute() {
...
const s = StyleSheet.create({
  ...
  title: { fontFamily: font.extrabold, fontSize: 20, color: '#1C1C1E', letterSpacing: -0.4 },
  sub: { fontFamily: font.regular, fontSize: 13, color: '#8E8E93', marginTop: 2 },
  ...
  sectionNumTxt: { fontFamily: font.extrabold, fontSize: 13 },
  sectionTitle: { fontFamily: font.extrabold, fontSize: 16, color: '#1C1C1E', letterSpacing: -0.3 },
  ...
  cardLabel: { fontFamily: font.extrabold, fontSize: 15, color: '#1C1C1E', letterSpacing: -0.2 },
  cardSub: { fontFamily: font.regular, fontSize: 12, color: '#8E8E93', marginTop: 3 },
  rangeBanner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  rangeTxt: { fontFamily: font.semibold, fontSize: 14, color: ACCENT },
  ...
  fmtLabel: { fontFamily: font.extrabold, fontSize: 14, color: '#1C1C1E' },
  fmtDesc: { fontFamily: font.regular, fontSize: 11, color: '#8E8E93', textAlign: 'center' },
  contentCard: {
    backgroundColor: '#fff',
    borderRadius: 22,
    overflow: 'hidden',
  ...
  contentTitle: { fontFamily: font.bold, fontSize: 14, color: '#1C1C1E' },
  contentDesc: { fontFamily: font.regular, fontSize: 12, color: '#8E8E93', marginTop: 2 },
  toggleCircle: {
    width: 26,
    height: 26,
    borderRadius: 13,
  ...
  shareTxt: { fontFamily: font.extrabold, fontSize: 16, color: ACCENT },
  dlBtn: {
    flex: 1,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  dlTxt: { fontFamily: font.extrabold, fontSize: 16, color: '#fff' },
  actionNote: {
